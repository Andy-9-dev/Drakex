# School Website Template: Drakex
...
For a closer look, check out the [live demo](https://okafor-chiagozie.github.io/Drakex) or download the project and open the `index.html` file in your web browser.

## Getting Started
1. Clone the repository
   ```bash
   git clone https://github.com/Okafor-Chiagozie/Drakex.git
   ```
